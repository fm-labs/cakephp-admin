...
return [
    ...
    'prevDisabled' => '<div class="prev disabled item icon"><i class="left arrow icon"></i> {{text}}</div>',
    'counterRange' => '{{start}} - {{end}} of {{count}}',
    'counterPages' => '{{page}} of {{pages}}',
    'first' => '<a class="first item" href="{{url}}">{{text}}</a>',
    'last' => '<a class="last item" href="{{url}}">{{text}}</a>',
