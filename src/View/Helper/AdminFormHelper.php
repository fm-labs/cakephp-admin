...
class AdminFormHelper extends BootstrapFormHelper
{
    ...
    public function __construct(View $View, array $config = [])
    {
        ...
        $widgets = [
            ...
            // Sumo Select
            'select' => ['Sugar\View\Widget\SumoSelectBoxWidget', '_view'],
            // Select2
            //'select' => ['Admin\View\Widget\Select2Widget', '_view'],
            // TinyMCE Html Editor
            'htmleditor' => ['Sugar\View\Widget\HtmlEditorWidget', '_view'],
            //'htmltext' => ['Admin\View\Widget\HtmlTextWidget', '_view'],
            // Date and Time Pickers
            'datetime' => ['Sugar\View\Widget\DatePickerWidget', 'text', '_view'], // override CakePHP built-in datetime control
            'datepicker' => ['Sugar\View\Widget\DatePickerWidget', 'text', '_view'],
            'timepicker' => ['Sugar\View\Widget\TimePickerWidget'],
            // ACE Code Editor
