 ...
 *
 */
class BackendUsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'last_login_datetime' => ['type' => 'datetime', 'length' => null, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null],
        'created' => ['type' => 'datetime', 'length' => null, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null],
        'modified' => ['type' => 'datetime', 'length' => null, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null],
        '_indexes' => [
            'username_pass' => ['type' => 'index', 'columns' => ['username', 'password'], 'length' => []],
        ],
        '_constraints' => [
...
'engine' => 'InnoDB', 'collation' => 'utf8_general_ci'
    ...
    public $records = [
        [
            ...
            'active' => 1,
            'last_login_datetime' => '2015-02-09 13:50:35',
            'created' => '2015-02-09 13:50:35',
            'modified' => '2015-02-09 13:50:35'
        ],
    ];
}
