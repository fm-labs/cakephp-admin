(function ($) {
    ...
    AdminJs.loadCss = function (filename) {
        ...
        if (this._cssLoaded.find(function (f) {
            return f == filename})) {
    ...
    AdminJs.loadJs = function (filename) {
        ...
        if (this._jsLoaded.find(function (f) {
            return f == filename})) {
    ...
    AdminJs.Flash = {
        ...
        success: function (msg, persist) {
            this.message('success', msg, persist); },
        warn: function (msg, persist) {
            this.message('warning', msg, persist); },
        error: function (msg, persist) {
            this.message('danger', msg, persist); },
        info: function (msg, persist) {
            this.message('info', msg, persist); },
